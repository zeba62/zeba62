...
education:
  [
    "B.Tech in Computer Science and Engineering, KMCLU 2025",
    "Android Development Internship & Summer Training",
    "Highschool and Intermediate ISC Board"
  ]
...
technical_background:
  [
    "Intern - Android Development (Firebase, REST APIs, Jetpack Compose)",
    "Smart India Hackathon Team Leader",
    "Koltin, Java, Jetpack Compose, XML, TensorFlow, AI, Firebase, etc"
  ]

currently_learning: ["Advanced Android, Jetpack Compose, AI Integration"]
goals_2025: ["Build impactful mobile apps and contribute to open source projects"]
hobbies: ["Coding", "Tech Events", "Exploring New Tools", "Drawing"]
